...
def crop_by_position(img, position, size):
    ...
    return {
        ...
        'center_left': img[height // 2 - size // 2:height // 2 + size // 2, width // 2 - size // 2:width // 2 + size // 2],
        'center': img[height // 2 - size // 2:height // 2 + size // 2, width // 2 - size // 2:width // 2 + size // 2],
        'center_right': img[height // 2 - size // 2:height // 2 + size // 2, width // 2 - size // 2:width // 2 + size // 2],
        'bottom_left': img[height - size:height, width // 2 - size // 2:width // 2 + size // 2],
